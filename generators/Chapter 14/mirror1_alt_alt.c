/* mirror1_alt_alt.c - produces mirror structures */
...
#define DENSITY 2		/* Density is must be a constant of 2 and is not used in this program */
...
notes played are represented as 1. Hence there are lots 
...
/*for (i = 0;i < 128; ++i)
if (nodes[i] == 1) printf("%d\n",i); 
for (i = 0; i < 128; ++i)
{
if ((nodes[i+1] == nodes[i]) && (nodes[i] == 1))
printf("%d node is left node\n",i);
} 
*/
...
/* some active nodes will be given the value 1, in which case it 
