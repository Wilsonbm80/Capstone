/* mirror2_alt_alt.c - produces mirror structures with double nodes and chords using atonal devices */
#include<stdio.h>
#include<stdlib.h>
#include<time.h>
#include "convert3.h"
...
#define DENSITY  2/		/* Here density must be 2, so this is a constant and a dummy define statement */
