...
int prime[12] = {0,7,4,1,10-12,5,6,9,2,3,8-12,11-12}; 
int retrograde[12] = {11-12,8-12,3,2,9,6,5,10-12,1,4,7,0};
int retrogradeinversion[12] =  {1,4,9-12,10-12,3-12,6-12,7-12,2,11-12,8-12,5-12,0};
int inversion[12] = {0,5-12,8-12,11-12,2,7-12,6-12,3-12,10-12,9-12,4,1};
...
int p_rhythm_notes[24] =  {0,7,7,7,4,4,              1,1,10-12,5,5,5,                      6,6,9,9,9,2,              3,3,3,8-12,11-12,11-12};
int r_rhythm_notes[24] =  {11-12,11-12,8-12,3,3,3,   2,9,9,9,6,6,                          5,5,5,10-12,1,1,          4,4,7,7,7,0};
int ri_rhythm_notes[24] = {1,1,4,4,4,9-12,          10-12,10-12,10-12,3-12,6-12,6-12,      7-12,2,2,2,11-12,11-12,   8-12,8-12,5-12,0,0,0};
int i_rhythm_notes[24] =  {0,0,0,5-12,8-12,8-12,    11-12,11-12,2,2,2,7-12,       6-12,6-12,3-12,10-12,10-12,10-12,  9-12,4,4,4,1,1};
...
int old_pnote,new_pnote,old_rinote,new_rinote,old_rnote,new_rnote,old_inote,new_inote;
